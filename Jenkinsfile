node{
    ...
    stage('git code checkout'){
        try{
            ...
            git 'https://github.com/Manjunath348/star-agile-insurance-project.git'
        }
        catch(Exception e){
    ...
    stage('Containerize the application'){
        ...
        sh "${dockerCMD} build -t manjunath348/insure-me:${tagName} ."
    }
    ...
    stage('Pushing it ot the DockerHub'){
        ...
        sh "${dockerCMD} push manjunath348/insure-me:${tagName}"
